...
$ npm install request
下記ソースコード実行
$ node 0312018162_npm_learn.js
*/

const request = require('request');
// Webページにアクセスする(Expressホーム画面)
request.get('https://expressjs.com/', function(err, res, body)
{
    // エラー処理
    if (err)
    {
...
<div class="express"><a href="/">Express</a><a href="en/changelog/4x.html#4.17.1" id="express-version">4.17.1</a></div>
...
<p>
The alpha <a href="en/5x/api.html">API documentation</a> is a work in progress. For information on what’s in the release, see the Express <a href="https://github.com/expressjs/express/blob/5.0/History.md">release history</a>.
</p>
</li>
</ul>
</section>
...
<script async defer src="https://buttons.github.io/buttons.js" type="3f2bd731e278e1baf591922c-text/javascript"></script>
<script type="3f2bd731e278e1baf591922c-text/javascript" src="https://cdn.jsdelivr.net/npm/docsearch.js@2/dist/cdn/docsearch.min.js" onload="docsearch({
  apiKey: '7164e33055faa6ecddefd9e08fc59f5d',
  indexName: 'expressjs',
  inputSelector: '#q',
  algoliaOptions: { 'facetFilters': ['lang:en'] }
})" async></script>
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="3f2bd731e278e1baf591922c-|49" defer=""></script></body>
</html>
*/